...
const Tag = "WSCircleProgressView";


export  default  class WSCircleProgressView extends Component {
    ...
    static defaultProps = {
        ...
        progressBaseColor: 'yellow',
        centerViewMode: true,
        textStyle:{
            fontSize: ProgramStyleSheet.getSize(20),
            color: 'black'
        },
    ...
    getCenterView() {
        ...
        let  percent = (progress / totalNum)*100
            ...
            return (
                <View key="centerView" style={[myStyles.centerViewStyle, {
                    ...
                    <View style={myStyles.ViewStyle}>
                        <Text style={this.props.textStyle} >{percent}%</Text>
                    </View>
                    {/*{this.props.children}*/}
                </View>
            );
