...
class WSSegmentView extends React.Component{
    constructor(props) {
        super(props)
        this.state = {
    ...
    static defaultProps = {
        ...
        borderWidth: 0,
        selectedIndex: 0,
        type: 'plain',//React.PropTypes.oneOf(['radius','plain','radius_space_between']),
        mainColor: 'red'
    }
