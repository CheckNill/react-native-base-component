...
import {LatLng, Region} from "react-native-amap3d/lib/js/PropTypes";
...
// requireNativeComponent 自动把'WSRNMapView'解析为'WSRNMapViewManager'
export const WSRNMapView = requireNativeComponent('WSRNMapView', null);

export class WSMapView extends React.Component{
    static propTypes = {
        ...ViewPropTypes,
        /**
         ...
         * */
        userTrackingMode: PropTypes.INT,
